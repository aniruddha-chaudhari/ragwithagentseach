...
def process_web(url: str) -> List:
    ...
    print(f"Title of the web document: {title}")
...
def prepare_document(file_path: str) -> List[Document]:
    ...
    try:
        ...
        if file_extension in ['.png', '.jpg', '.jpeg', '.gif', '.webp']:
            prompt = """
            Please analyze and describe this file in detail. Include:
            1. Type of content and main subject
            2. Key information or features
            3. Structure and organization
            4. Visual elements (if applicable)
            5. Any text or key data points present
            6. Overall purpose and intended audience
